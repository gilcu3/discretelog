...
[yafu](https://github.com/bbuhrow/yafu/) is a state of the art hobbyist tool to
...
I personally have the following script on my `PATH`, making `yafu` accessible
...
accessible to other programs. `cado-nfs` was compiled in `~/opt/cado-nfs`, and
